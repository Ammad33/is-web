...
const Signup = () => {
  ...
  const [passwordShown, setPasswordShown] = useState(
    false
  ); /*{bool} used to hide and show the password*/
  const [name, setFullname] = useState(
    ""
  ); /*{string} to store the name of the user*/
  const [username, setEmail] = useState(
    ""
  ); /*{string} to store the username(email) of the user*/
  const [password, setPassword] = useState(
    ""
  ); /*{string} to store the password of the user*/
  const [errorMessage, setErrorMessage] = useState(
    ""
  ); /*{string} to store the error massage*/
  const [errorState, setErrorState] = useState(
    false
  ); /*{bool} to check if error state is occured*/
  ...
  return (
    <div className={styles.signupContainer}>
      ...
      <TextField
        ...
        InputProps={{
          /*adding eye icon inside the text field using input props*/
          endAdornment: (
